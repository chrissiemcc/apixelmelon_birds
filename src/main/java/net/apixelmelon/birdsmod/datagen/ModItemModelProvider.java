...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    public ModItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, BirdsMod.MOD_ID, existingFileHelper);
    }
    ...
    private void complexBlock(Block block) {
        withExistingParent(ForgeRegistries.BLOCKS.getKey(block).getPath(), new ResourceLocation(BirdsMod.MOD_ID,
                "block/" + ForgeRegistries.BLOCKS.getKey(block).getPath()));
    }

    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = BirdsMod.MOD_ID;
    ...
    private void saplingItem(RegistryObject<Block> block) {
        this.withExistingParent(block.getId().getPath(),
                ...
                new ResourceLocation(BirdsMod.MOD_ID,"block/" + block.getId().getPath()));
    }

    private void simpleItem(RegistryObject<Item> item) {
        this.withExistingParent(item.getId().getPath(),
                new ResourceLocation("item/generated")).texture("layer0",
                new ResourceLocation(BirdsMod.MOD_ID, "item/" + item.getId().getPath()));
    ...
    private void fenceItem(RegistryObject<Block> block, RegistryObject<Block> baseBlock) {
        this.withExistingParent(ForgeRegistries.BLOCKS.getKey(block.get()).getPath(), mcLoc("block/fence_inventory"))
                .texture("texture", new ResourceLocation(BirdsMod.MOD_ID, "block/" + ForgeRegistries.BLOCKS.getKey(baseBlock.get()).getPath()));
    }
    ...
    private void wallItem(RegistryObject<Block> block, RegistryObject<Block> baseBlock) {
        this.withExistingParent(ForgeRegistries.BLOCKS.getKey(block.get()).getPath(), mcLoc("block/wall_inventory"))
                .texture("wall", new ResourceLocation(BirdsMod.MOD_ID, "block/" + ForgeRegistries.BLOCKS.getKey(baseBlock.get()).getPath()));
    }

    private void trapdoorItem(RegistryObject<Block> block) {
        this.withExistingParent(BirdsMod.MOD_ID + ":" + ForgeRegistries.BLOCKS.getKey(block.get()).getPath(),
    ...
    private void simpleBlockItem(RegistryObject<Block> block) {
        try {
            this.withExistingParent(block.getId().getPath(),
                    new ResourceLocation("item/generated")).texture("layer0",
                    new ResourceLocation(BirdsMod.MOD_ID, "item/" + block.getId().getPath()));
        }
